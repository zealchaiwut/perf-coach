  ...
  var LINKS = [
    {
      ...
      label: "Home",
      icon: "ti-home",
      match: ["/", "/home", "/home.html"],
    },
    {
      href: "/log",
      label: "Training Log",
      icon: "ti-list-details",
      match: ["/log", "/training", "/training.html"],
    },
    {
      href: "/weight",
      label: "Weight",
      icon: "ti-scale",
      match: ["/weight", "/weight.html"],
    },
    {
      href: "/habits",
      label: "Habits",
      icon: "ti-checklist",
      match: ["/habits", "/habits.html"],
    },
    {
      href: "/trends",
      label: "Trends",
      icon: "ti-chart-line",
      match: ["/trends", "/trends.html"],
      disabled: true,
    },
    {
      href: "/calendar",
